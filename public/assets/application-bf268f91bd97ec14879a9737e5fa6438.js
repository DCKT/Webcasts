...
(function() {
  $(function() {
    ...
    window.onresize = function() {
      return $('aside').css('height', window.innerHeight - 80);
    };
    ...
    return $('#search').keypress(function(e) {
      var query;
      if (e.which === 13) {
        query = $(this).val();
        return $.ajax({
          ...
          success: function(datas) {
            var data, html, i, img, link, result, results, titre, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
            $('.result').remove();
            results = [];
            _ref = datas[0];
            ...
            return $('.search-results').slideDown();
          }
        });
      }
    });
